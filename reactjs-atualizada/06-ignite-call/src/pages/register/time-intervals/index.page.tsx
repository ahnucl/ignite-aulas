...
const timeIntervalFormSchema = z.object({
  intervals: z
    ...
    .refine((intervals) => intervals.length > 0, {
      message: 'Você precisa selecionar pelo um dia da semana!',
    })
    .transform((intervals) =>
...
type TimeIntervalFormOutput = z.output<typeof timeIntervalFormSchema> // z.output faz o mesmo que o z.infer mas de forma semântica
